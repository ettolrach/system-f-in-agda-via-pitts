...
\begin{code}
  ...
  ty-ty[ k :→ T ] ‵ℕ = ‵ℕ
  ty-ty[ k :→ T ] (t-free x) = t-free x
  ty-ty[ k :→ T ] (t-bound i) with k ≟ℕ i
  ... | yes refl = T
  ... | no  _    = t-bound i
  ...
  ty-tm[ k :→ T ] (free x) = free x
  ty-tm[ k :→ T ] (bound i) = bound i
  ...
  tm-tm[ k :→ N ] (free x) = free x
  tm-tm[ k :→ N ] (bound i) with k ≟ℕ i
  ... | yes refl = N
  ... | no  _    = bound i
