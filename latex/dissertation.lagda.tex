...
\newunicodechar{ℕ}{{\cambriamath{ℕ}}}
\newunicodechar{∀}{{\cambriamath{∀}}}
\newunicodechar{≡}{{\cambriamath{≡}}}
\newunicodechar{≥}{{\cambriamath{≥}}}
\newunicodechar{≤}{{\cambriamath{≤}}}
\newunicodechar{≰}{{\cambriamath{≰}}}
...
\newunicodechar{∈}{{\cambriamath{∈}}}
\newunicodechar{∉}{{\cambriamath{∉}}}
\newunicodechar{λ}{{\cambriamath{λ}}}
\newunicodechar{И}{{\cambriamath{И}}}
\newunicodechar{∘}{{\cambriamath{∘}}}
\newunicodechar{≠}{{\cambriamath{≠}}}
\newunicodechar{‵}{{\ibmplexmath{‵}}}
\newunicodechar{ƛ}{{\cambriamath{ƛ}}}
\newunicodechar{≻}{{\cambriamath{≻}}}
\newunicodechar{⦃}{{\cambriamath{⦃}}}
\newunicodechar{⦄}{{\cambriamath{⦄}}}
\newunicodechar{′}{{\cambriamath{′}}}
...
\newunicodechar{∅}{{\cambriamath{∅}}}
\newunicodechar{⊢}{{\cambriamath{⊢}}}
\newunicodechar{ξ}{{\cambriamath{ξ}}}
\newunicodechar{β}{{\cambriamath{β}}}
\newunicodechar{↠}{{\cambriamath{↠}}}
\newunicodechar{ρ}{{\cambriamath{ρ}}}
\newunicodechar{σ}{{\cambriamath{σ}}}
\newunicodechar{⊆}{{\cambriamath{⊆}}}
\newunicodechar{⊎}{{\cambriamath{⊎}}}
\newunicodechar{∧}{{\cambriamath{∧}}}
\newunicodechar{ʳ}{{\cambriamath{ʳ}}}
\newunicodechar{ˡ}{{\cambriamath{ˡ}}}
\newunicodechar{ᵀ}{{\cambriamath{ᵀ}}}
...
in appendix \ref{appendix:f_local_closure}. In fact, repeated proofs will be omitted from the main
text henceforth and placed in the appendix unless the other proofs are substantially different.
\begin{code}
...
We want to apply an equality in a type judgement. It is easiest to do so by defining
