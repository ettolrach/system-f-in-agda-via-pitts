...
\newfontface{\unicodemonofont}{Noto Sans Mono Regular}
\newfontface{\ibmplexmath}{IBM Plex Math}
\newunicodechar{ℕ}{{\unicodemonofont{ℕ}}}
\newunicodechar{∀}{{\unicodemonofont{∀}}}
\newunicodechar{≡}{{\unicodemonofont{≡}}}
\newunicodechar{≥}{{\unicodemonofont{≥}}}
\newunicodechar{≤}{{\unicodemonofont{≤}}}
\newunicodechar{≰}{{\unicodemonofont{≰}}}
...
\newunicodechar{∈}{{\unicodemonofont{∈}}}
\newunicodechar{∉}{{\unicodemonofont{∉}}}
\newunicodechar{λ}{{\unicodemonofont{λ}}}
\newunicodechar{И}{{\unicodemonofont{И}}}
\newunicodechar{∘}{{\unicodemonofont{∘}}}
\newunicodechar{≠}{{\unicodemonofont{≠}}}
\newunicodechar{‵}{{\unicodemonofont{‵}}}
\newunicodechar{ƛ}{{\unicodemonofont{ƛ}}}
\newunicodechar{≻}{{\unicodemonofont{≻}}}
...
\newunicodechar{∅}{{\unicodemonofont{∅}}}
\newunicodechar{⊢}{{\unicodemonofont{⊢}}}
\newunicodechar{ξ}{{\unicodemonofont{ξ}}}
\newunicodechar{β}{{\unicodemonofont{β}}}
\newunicodechar{↠}{{\unicodemonofont{↠}}}
...
Fresh variables are those whose identifier (i.e. \text{String}) hasn't already been used for any
